...
import { MaintenancePhaseService } from "src/treatment-protocols/allergen-immunotherapy/maintenance-phase/maintenance-phase.service";
...
import { RegisterNextScheduledMaintenanceUseCase } from "src/treatment-protocols/allergen-immunotherapy/maintenance-phase/register-scheduled-maintenance.use-case";
import { BUILD_UP_INTERVAL, STARTING_DOSE_CONCENTRATION, STARTING_DOSE_VOLUME } from "src/treatment-protocols/allergen-immunotherapy/build-up-phase/build-up-phase.variables";
