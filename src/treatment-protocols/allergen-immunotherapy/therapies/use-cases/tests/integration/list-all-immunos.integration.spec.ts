...
import { ListAllImmunotherapiesUseCase } from "../../list-all-immunotherapies.use-case";
...
describe('ListAllImunotherapiesUseCase - Integration', () => {
    ...
    it('should return an empty list when from another organization', async () => {
        ...
        const result = await listAllUseCase.execute(authenticatedUserAnotherOrg.activeOrgId);
